/**
 * @file lv_ygas_cold_hips.h
 * Header file for class lv_ygas_cold_hips
 */

#ifndef LV_YGAS_COLD_HIPS_H
#define LV_YGAS_COLD_HIPS_H
...
class lv_ygas_cold_hips : public lv {
    ...
    public:
        ...
        lv_ygas_cold_hips(){}
        lv_ygas_cold_hips(odtline     *line,
                const string       s,
                const bool         Lt,
                const bool         Lo=true);

        virtual ~lv_ygas_cold_hips(){}
